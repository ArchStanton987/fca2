...
import { getBase } from "utils/char-calc"
...
export type Special = {
  ...
  short: string
  description: string
  getBase: (dbAbilities: DbAbilities, key: SpecialId) => number
}

const special: Record<SpecialId, Special> = {
  strength: {
    id: "strength",
    label: "Force",
    short: "FO",
...
export const specialArray = Object.values(special)
